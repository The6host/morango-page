...
const Navigation = () => {
  ...
  const navItems = [
    { label: 'Morangos do Amor', href: '#hero' },
    { label: 'Benefícios', href: '#benefits' },
    { label: 'Depoimentos', href: '#testimonials' },
    { label: 'Oferta', href: '#offer' },
    { label: 'Garantir Vaga', href: '#final-cta' },
  ];

  return (
    <nav className="fixed top-0 left-0 right-0 bg-gray-900/95 backdrop-blur-sm border-b border-red-900/20 z-50">
